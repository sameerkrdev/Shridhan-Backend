...
const SYSTEM_ROLE_PERMISSIONS: Record<string, string[]> = {
  OWNER: [
    ...
    "recurring_deposit.create",
    "recurring_deposit.read",
    "recurring_deposit.list",
    "recurring_deposit.pay",
    "recurring_deposit.withdraw",
    "recurring_deposit.remove",
    "recurring_deposit.remove_project_type",
  ],
  ADMIN: [
    "membership.create",
    "membership.read",
